#!/usr/bin/env python
#
#  Copyright (c) 2018, socialmediawall.io
#
#  Dev: https://github.com/socialmediawall-io/Python-Socialwall-Slideshow
#  License: GPLv3
...
if __name__ == '__main__':
    ...
    #social wall developer application ID details
    ...
    if 'posts' in resultdata:
        for post in resultdata['posts']:
            try:
                ...
                urllib.request.urlretrieve(post['imagelink'], "{}/{}.jpg".format(args.dir.rstrip('/'), post['postid']))
                print ('Done')
            except Exception as e:
                print (e)
                pass
            
    # Following code is from py-slideshow repository to show slideshow of downloaded images
